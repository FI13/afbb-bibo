...
public interface Messages {
	...
	public static final String ISBN = "ISBN";//$NON-NLS-1$
	public static final String TITLE = "Titel";
	public static final String AUTHOR = "Autor";
	public static final String PUBLISHER = "Verlag";
	...
	public static final String LEND_CURATOR = "Ausgeliehen von";
	public static final String LEND_BORROWER = "Ausgeliehen an";
	public static final String RETURN_DATE = "Rückgabe am";
	public static final String RETURN_CURATOR = "Rückgabe an";
	public static final String RETURN_BORROWER = "Rückgabe von";
