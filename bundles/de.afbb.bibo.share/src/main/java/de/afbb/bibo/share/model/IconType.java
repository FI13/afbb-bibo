...
public enum IconType {
	NONE("NONE"), USER_MANAGE("USER_MANAGE"), BOOK_GROUP("BOOK_GROUP"), BOOK_DAMAGED("BOOK_DAMAGED"), BOOK_LENT(
			"BOOK_LENT"), BOOK_AVAILABLE("BOOK_AVAILABLE"), BOOK("BOOK"), CD("CD"), LOGIN("LOGIN"), PUPIL(
					"PUPIL"), TEACHER("TEACHER"), USER("USER"), ARROW_UP("ARROW_UP"), ARROW_DOWN("ARROW_DOWN"), PLUS(
							"PLUS"), MINUS("MINUS"), SAVE("SAVE"), LOGO("LOGO"), MEDIA("MEDIA"), MEDIA_ADD(
									"MEDIA_ADD"), HELP("HELP"), USER_MANAGE_ADD("USER_MANAGE_ADD"), BOOK_ADD(
											"BOOK_ADD"), BOOK_GROUP_ADD("BOOK_GROUP_ADD"), CD_ADD(
