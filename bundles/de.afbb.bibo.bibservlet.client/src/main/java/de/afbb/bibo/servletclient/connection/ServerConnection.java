...
public class ServerConnection {
     ...
     *
     * @param url The part of the url after the HOST:PORT part (for Example
     * http://localhost:8080 will automatically be appended to the request.)
     * @param method The request method. The server understands "GET" and
     * "POST".
     * @param params The request parameters, put in a map. 
     * @param json An object parsed to JSON which will be sent to the server.
     * @return HttpResponse
     * @throws java.net.ConnectException
     */
    public HttpResponse request(String url, String method, Map<String, String> params, String json) throws ConnectException {
        //Check for logged in
     ...
     * @throws java.net.ConnectException if there was an error with the request
     * or if the recieved status code was wrong.
     */
